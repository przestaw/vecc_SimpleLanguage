...
if [ -f "$EXE" ]; then
    ...
    $EXE -v 2 -i ./example_files/example_1.vecc

        echo $EXE -i ./example_files/example_2.vecc
    $EXE -v 2 -i ./example_files/example_2.vecc

        echo $EXE --vec -i ./example_files/example_3.vecc
    $EXE --vec -v 2 -i ./example_files/example_3.vecc

        echo $EXE --vec -i ./example_files/example_4.vecc
    $EXE --vec -v 2 -i ./example_files/example_4.vecc

        echo $EXE --fib -i ./example_files/example_fib.vecc
    $EXE --fib -v 2 -i ./example_files/example_fib.vecc
else
