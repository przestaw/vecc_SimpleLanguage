...
BOOST_AUTO_TEST_SUITE(Language_Test_Suite)
    ...
    BOOST_AUTO_TEST_CASE(VeccLibraryTestProduct2_Works_1) {
        ...
        BOOST_CHECK_EQUAL(true, static_cast<bool>(program->run().variable_ == Variable({0,5})));
    }
    ...
    BOOST_AUTO_TEST_CASE(VeccLibraryTestProduct2_Works_2) {
        ...
        BOOST_CHECK_EQUAL(true, static_cast<bool>(program->run().variable_ == Variable({-5,10})));
    }
    ...
    BOOST_AUTO_TEST_CASE(VeccLibraryTestProduct3_Works_1) {
        ...
        BOOST_CHECK_EQUAL(true, static_cast<bool>(program->run().variable_ == Variable({0,0,0})));
    }
    ...
    BOOST_AUTO_TEST_CASE(VeccLibraryTestProduct3_Works_2) {
        ...
        BOOST_CHECK_EQUAL(true, static_cast<bool>(program->run().variable_ == Variable({-2,4,-2})));
    }
    ...
    BOOST_AUTO_TEST_CASE(FibLibraryTestIt_Works_1) {
        ...
        BOOST_CHECK_EQUAL(true, static_cast<bool>(program->run().variable_ == Variable({89})));
    }
    ...
    BOOST_AUTO_TEST_CASE(FibLibraryTestIt_Works_2) {
        ...
        BOOST_CHECK_EQUAL(true, static_cast<bool>(program->run().variable_ == Variable({10946})));
    }
