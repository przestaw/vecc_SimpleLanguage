...
const std::unordered_map<std::string, Token::Type> Token::keywords = {
    {"fun", Token::Type::Function},  {"if", Token::Type::If},
    {"while", Token::Type::While},   {"else", Token::Type::Else},
    {"return", Token::Type::Return}, {"and", Token::Type::And},
    {"or", Token::Type::Or},         {"var", Token::Type::Var},
    {"vec", Token::Type::Vec},       {"print", Token::Type::Print}};
...
const std::unordered_map<char, std::function<Token::Type(const char &)>>
    Token::twoCharOperators = {
        {'=',
         [](const char &got) {
           return checkSymbol(got, '=', Token::Type::Equality);
         }},
        {'<',
         [](const char &got) {
           return checkSymbol(got, '=', Token::Type::LessOrEqual);
         }},
        {'>',
         [](const char &got) {
           return checkSymbol(got, '=', Token::Type::GreaterOrEqual);
         }},
        {'!', [](const char &got) {
           return checkSymbol(got, '=', Token::Type::Inequality);
         }}};
